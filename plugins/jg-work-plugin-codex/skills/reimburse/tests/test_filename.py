...
def test_parse_gaode():
    r = parse_gaode_filename("【曹操出行-185.82元-3个行程】高德打车电子发票.pdf")
    assert r == {"platform": "曹操出行", "amount": 185.82, "trip_count": 3}
...
def test_non_gaode():
    assert parse_gaode_filename("26319166100008219443.pdf") is None
